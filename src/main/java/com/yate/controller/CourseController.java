...
/**
 * The CourseController is a REST controller that provides endpoints for managing courses.
 * It includes functions to add, retrieve, update, and delete courses, as well as
